...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `sentry` with the `NAME` of your provider.
...
- binary: pulumi-resource-sentry
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-sentry/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-sentry/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-sentry_darwin_amd64_v1
│   └── pulumi-resource-sentry
├── pulumi-sentry_darwin_arm64
│   └── pulumi-resource-sentry
├── pulumi-sentry_linux_amd64_v1
│   └── pulumi-resource-sentry
├── pulumi-sentry_linux_arm64
│   └── pulumi-resource-sentry
├── pulumi-sentry_windows_amd64_v1
│   └── pulumi-resource-sentry.exe
└── pulumi-sentry_windows_arm64
    └── pulumi-resource-sentry.exe
```
