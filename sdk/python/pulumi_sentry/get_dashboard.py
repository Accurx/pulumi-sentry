...
class GetDashboardResult:
    ...
    @property
    @pulumi.getter
    def widgets(self) -> Sequence['outputs.GetDashboardWidgetResult']:
...
def get_dashboard(internal_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('sentry:index/getDashboard:getDashboard', __args__, opts=opts, typ=GetDashboardResult).value
...
def get_dashboard_output(internal_id: Optional[pulumi.Input[str]] = None,
