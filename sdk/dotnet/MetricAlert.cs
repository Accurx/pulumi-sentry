...
{
    [SentryResourceType("sentry:index/metricAlert:MetricAlert")]
    public partial class MetricAlert : global::Pulumi.CustomResource
    {
        ...
        [Output("triggers")]
        public Output<ImmutableArray<Outputs.MetricAlertTrigger>> Triggers { get; private set; } = null!;
        ...
        public MetricAlert(string name, MetricAlertArgs args, CustomResourceOptions? options = null)
            : base("sentry:index/metricAlert:MetricAlert", name, args ?? new MetricAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricAlert(string name, Input<string> id, MetricAlertState? state = null, CustomResourceOptions? options = null)
            : base("sentry:index/metricAlert:MetricAlert", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetricAlertArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.MetricAlertTriggerArgs>? _triggers;
        public InputList<Inputs.MetricAlertTriggerArgs> Triggers
        {
            get => _triggers ?? (_triggers = new InputList<Inputs.MetricAlertTriggerArgs>());
            set => _triggers = value;
        }
    ...
    public sealed class MetricAlertState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("triggers")]
        private InputList<Inputs.MetricAlertTriggerGetArgs>? _triggers;
        public InputList<Inputs.MetricAlertTriggerGetArgs> Triggers
        {
            get => _triggers ?? (_triggers = new InputList<Inputs.MetricAlertTriggerGetArgs>());
            set => _triggers = value;
        }
