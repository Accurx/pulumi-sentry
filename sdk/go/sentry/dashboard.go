...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("sentry:index/dashboard:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("sentry:index/dashboard:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DashboardOutput) InternalId() pulumi.StringOutput {
	return o.ApplyT(func(v *Dashboard) pulumi.StringOutput { return v.InternalId }).(pulumi.StringOutput)
}

// The slug of the organization the dashboard belongs to.
func (o DashboardOutput) Organization() pulumi.StringOutput {
	return o.ApplyT(func(v *Dashboard) pulumi.StringOutput { return v.Organization }).(pulumi.StringOutput)
}
